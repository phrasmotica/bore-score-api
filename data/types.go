...
type IDatabase interface {
	...
	GetGroup(ctx context.Context, id string) (RetrieveGroupResult, *models.Group)
	GetGroupByName(ctx context.Context, name string) (RetrieveGroupResult, *models.Group)
